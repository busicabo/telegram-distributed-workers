...
import com.downloadvideo.application.download.YoutubeQualityDownload;
        ...
        executor.execute(new Runnable() {
            ...
            public void run() {
                ...
                if(responseDto.getYoutubeQuality().isEmpty()){
                    ...
                    sendMessage.setChatId(searchMessage.getChatId());
                    sendMessage.setMessageId(searchMessage.getMessageId());
                    sendMessage.setText("❗ Видео не было найдено! Максимальный размер видео не более 2гб.");
                    sendTelegram.editMessage(sendMessage);
                ...
                if(youtubeQuality.getTranslateVoice().get("uk")!=null){
                    videoDataSave.setUk_id(youtubeQuality.getTranslateVoice().get("uk"));
                }
