...
Проверяется доступ к команде через aop. com.downloadvideo.aop.CheckAdminGroup
...
public class AdminCommandHandler implements MessageHandlers {
    ...
    private final List<String> commands = List.of("/block","/error","/getUser","/getCountUsers","/sendMessage");
    @Override
