...
import com.downloadvideo.service.SendNewTask;
import com.downloadvideo.service.SendTelegram;
import com.downloadvideo.service.VideoDataService;
import com.downloadvideo.service.handler.main.CallbackHandler;
...
public class QualityHandler implements CallbackHandler {
    ...
    public void handle(CallbackEvent event) {
        ...
        if(ru.isEmpty() && en.isEmpty()
                || !ru.isEmpty() && en.isEmpty() && videoData.getAudio_id().equals(videoData.getRu_id())
                || ru.isEmpty() && !en.isEmpty() && videoData.getAudio_id().equals(videoData.getEn_id())){
